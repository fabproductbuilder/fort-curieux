/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 19bc502d65331eba54c0702915eab8fe)
// Runtime types generated with workerd@1.20260625.1 2026-06-26 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* fort-curieux-codex-next-temp */;
}
